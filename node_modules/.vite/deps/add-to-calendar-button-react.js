...
function be(t) {
  ...
  try {
    ...
    let n = a;
    return [n[0], Ie(Ht.details[n[1]])];
  } catch {
    return console.error("Given time zone not valid."), "";
  }
}
var ft = de;
function Ue(t, e = false) {
  let o = be(t);
...
function C(t, e, o) {
  ...
  for (let v = 0; v < p.length; v++) {
    ...
    if (E.startsWith("TZOFFSETTO") && (d++, u[`${d}`] && (u[`${d}`].offset = E.split(":")[1])), E.startsWith("DTSTART") && u[`${d}`] && (u[`${d}`].hour = parseInt(E.substr(17, 2))), E.startsWith("RRULE")) {
      let M = E.split(";"), dt = M[1].split("=")[1], ot = parseInt(dt);
    ...
    for (let [r, l] of Object.entries(n)) if (typeof l == "object" && !Array.isArray(l)) {
      ...
      for (let [s, b] of Object.entries(c)) if (typeof b == "object" && !Array.isArray(b)) {
        ...
        for (let [u, d] of Object.entries(p)) {
          let f = d, k = f[0].replace(new RegExp(`^${mt(r)}/${mt(s)}/`), `${ft.toplevel.indexOf(r)}/${s}/`);
          i[`${r}`][`${s}`][`${u}`] = [k, f[1]];
        }
      } else {
        let p = b, u = p[0].replace(new RegExp(`^${mt(r)}/`), `${ft.toplevel.indexOf(r)}/`);
        i[`${r}`][`${s}`] = [u, p[1]];
      }
    } else {
      let c = l, s = c[0].replace(new RegExp(`^${mt(r)}/`), `${ft.toplevel.indexOf(r)}/`);
      i[`${r}`] = [s, c[1]];
    }
    return i;
  })(ft.db), a = (n, i = "") => {
...
var q = () => !!(P() || B());
var rt = $() ? () => !!/; ?wv|(?:iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/i.test(navigator.userAgent) : () => false;
var $e = $() ? () => !!/Instagram/i.test(navigator.userAgent) : () => false;
var Bt = rt() ? "_system" : "_blank";
var Ne = ["apple", "google", "ical", "ms365", "outlookcom", "msteams", "yahoo"];
var je = ["apple", "google", "ical"];
var He = ["msteams"];
var Fe = ["ical"];
var Pe = ["apple"];
var S = [];
...
var Ke = ["dates"];
var qe = ["recurrence_byDay", "recurrence_byMonth", "recurrence_byMonthDay", "images", "options", "optionsMobile", "optionsIOS"];
var Ve = ["sequence", "recurrence_interval", "recurrence_count"];
var Q = {
...
async function It(t) {
  return t = We(t), t = Ge(t), t = Xe(t), t = po(t), t.sizes = uo(t.size), t.lightMode = mo(t.lightMode), t = fo(t), t = me(t), t = await zo(t), t;
}
function We(t) {
...
function Ge(t) {
  if (t.dates)
    ...
    Pt(t);
  return (!t.language || t.language === "" || !wa.includes(t.language)) && (t.language = "en"), t;
}
function Qe(t) {
  if (t.recurrence = t.recurrence.replace(/\s+/g, "").toUpperCase(), /^RRULE:/i.test(t.recurrence)) {
    t.recurrence_simplified = false;
    const e = Ee(t.recurrence, false);
...
function Je(t) {
  ...
  })(), b = !(o && o !== ""), p = ga(t.recurrence, s, r, b, i);
...
function Xe(t) {
  const { options: e, source: o } = to(t);
  let { newOptions: a, iCalGiven: n, appleGiven: i } = eo(e, t);
  a = co(t, a), { newOptions: a, iCalGiven: n } = so(a, n);
  const r = o !== "general" && (e.includes("ical") || e.includes("apple"));
  return a = bo(a, t, n, i, r), a.sort(), t.options = a, t;
}
function to(t) {
...
function eo(t, e) {
  ...
  for (let i = 0; i < t.length; i++) {
    const r = oo(t[`${i}`]);
    r === "apple" && (n = true), r === "ical" && (a = true), !ao(r, e) && o.push(r);
  }
...
function ao(t, e) {
  return no(t, e) || ro(t, e) || io(t, e) || lo(t, e);
}
function no(t, e) {
  const o = (B() || e.fakeIOS) && Fe.includes(t) && (!e.optionsIOS || e.optionsIOS.length === 0) && (!e.optionsMobile || e.optionsMobile.length === 0), a = (P() || e.fakeMobile || e.fakeAndroid) && Pe.includes(t) && (!e.optionsMobile || e.optionsMobile.length === 0);
  return o || a;
}
function ro(t, e) {
  if (!e.recurrence || e.recurrence === "") return false;
  const o = !je.includes(t), a = (B() || e.fakeIOS) && t === "google";
  return o || a;
}
function io(t, e) {
  return e.subscribe && He.includes(t);
}
function lo(t, e) {
...
function fo(t) {
  return t.language.length > 2 && (t.language = t.language.substring(0, 2)), ya.includes(t.language) ? t.rtl = true : t.rtl = false, t;
}
function me(t) {
  (!t.dates || !Array.isArray(t.dates)) && (t.dates = [{ name: t.name }]), t.recurrence && t.recurrence !== "" && (t = Qe(t), t = Zt(t, 0), t = Kt(t, 0), t = Je(t)), t.recurrence && t.recurrence !== "" && (t.dates[0].recurrence = t.recurrence);
  for (let o = 0; o < t.dates.length; o++)
    t = Zt(t, o), t = Kt(t, o), t = ho(t, o), t = go(t, o), t = vo(t, o), t = yo(t, o), t = xo(t, o);
  t = To(t);
...
function Kt(t, e) {
  const o = t.dates[`${e}`], a = wo(o);
  return o.startDate = a.startDate, o.endDate = a.endDate, o.startTime = a.startTime, o.endTime = a.endTime, o.timeZone = a.timeZone, o.timestamp = qt("timestamp", o.startDate, o.startTime, o.timeZone), o.overdue = qt("overdue", o.endDate, o.endTime, o.timeZone), t;
}
function ho(t, e) {
  const o = t.dates[`${e}`];
  return o.uid || (e === 0 && t.uid && t.uid !== "" ? o.uid = t.uid : t.uid && t.uid !== "" ? o.uid = `${t.uid}-${e + 1}` : o.uid = Se()), t;
}
function go(t, e) {
  const o = t.dates[`${e}`];
  return o.status = re(o.status, "upper"), o.availability = re(o.availability, "lower"), t;
}
function vo(t, e) {
  const o = (n) => n.replace(/(\\r\\n|\\n|\\r|<br(\s*\/?)>)/g, "");
...
function wo(t) {
  ...
  if ((!t.endDate || t.endDate === "") && (t.endDate = t.startDate), ["start", "end"].forEach(function(n) {
    ...
    if (!e(i) && !o(i))
      ...
      if ((/\+/.test(i) || o(i)) && (t[n + "Date"] = ko(i)), t[n + "Date"]) {
    ...
    if (pe().includes(n) || (n = va(n)), t.useUserTZ && t.startTime && t.startTime !== "" && t.endTime && t.endTime !== "") {
      const r = oe(t.startDate, t.startTime, t.timeZone, n), l = oe(t.endDate, t.endTime, t.timeZone, n);
...
async function zo(t) {
  if (typeof Gt != "function" || !t.rsvp || !t.proKey || Object.keys(t.rsvp).length === 0) return t;
  if (t.rsvp.expired = (function() {
    return !!(t.rsvp && t.rsvp.expires && new Date(t.rsvp.expires) < /* @__PURE__ */ new Date());
  })(), t.rsvp.max) {
    const e = await Gt(t.proKey, t.dev);
...
async function fe(t) {
  ...
  try {
    return await he(t, e), await Ao(t, e), await So(t, e), await Eo(t, e), await Lo(t, e), await Yo(t, e), await Do(t, e), await $o(t, e), t.recurrence_simplified && await No(t, e), true;
  } catch (o) {
    throw new Error(o.message);
  }
}
async function he(t, e, o = "", a = "") {
  const n = (function() {
...
async function Do(t, e) {
  try {
    for (let o = 0; o < t.dates.length; o++) {
      ...
      await he(t, e, o, a), await _o(t, e, o, a), await Co(t, e, o, a), await Mo(t, e, o, a), await Ro(t, e, o, a), await Bo(t, e, o, a), await Io(t, e, o, a), await Oo(t, e, o, a), await Uo(t, e, o, a);
    }
    return true;
  } catch (o) {
    throw new Error(o.message);
...
async function Mo(t, e, o, a) {
  if (t.dates[`${o}`].organizer && t.dates[`${o}`].organizer !== "") {
    ...
    if (n.length !== 2 || n[0].length > 50 || n[1].length > 100 || !vt(n[1]))
...
async function Bo(t, e, o, a) {
  return /^(?:\w|-){1,254}$/.test(t.dates[`${o}`].uid) || (t.debug && console.warn(e + ": UID not valid. May only contain alpha, digits, and dashes; and be less than 255 characters. Falling back to an automated value!" + a), t.dates[`${o}`].uid = Se()), !/^[0-9a-f]{8}-[0-9a-f]{4}-[0-5][0-9a-f]{3}-[089ab][0-9a-f]{3}-[0-9a-f]{12}$/i.test(t.dates[`${o}`].uid) && t.debug && console.warn(e + ": UID is highly recommended to be a hex-encoded random Universally Unique Identifier (UUID)!" + a), true;
}
...
async function Oo(t, e, o, a) {
  if (!pe().includes(t.dates[`${o}`].timeZone))
...
async function Uo(t, e, o, a) {
  ...
  if (i.forEach((c) => {
    const s = n[`${c}`];
    if (s.length !== 10)
      throw new Error(`${e} failed: date misspelled [${s} -> YYYY-MM-DD]${a}`);
    const b = s.split("-");
    if (b.length !== 3)
    ...
    if (s) {
      if (s.length !== 5)
        throw new Error(`${e} failed: time misspelled [${s} -> HH:MM]${a}`);
      const b = s.split(":");
...
function D(t, e, o = "", a = null, n = false, i = false) {
  e == "open" ? Vt(t, o, a, n, i) : e == "close" || a.classList.contains("atcb-active") || t.querySelector(".atcb-active-modal") ? J(t, n) : Vt(t, o, a, n, i);
}
async function Vt(t, e, o = null, a = false, n = false) {
  if (t.querySelector(".atcb-list") || t.querySelector(".atcb-modal")) return;
  Y("openList", e.identifier, e.identifier), S.active = e.identifier;
  const i = Po(t, e), r = document.createElement("div");
  ...
  const l = we(t, e.trigger, e.listStyle === "modal", !e.hideBackground);
  if (e.listStyle === "modal") {
    const s = await st(t, e);
    s.querySelector(".atcb-modal-host-initialized").append(l), l.append(i), e.hideBranding || lt(s, false), ct(i, e.sizes), Ot(s), V(l);
  } else
    e.forceOverlay && (t = await Zo(t, e), o = t.querySelector("button.atcb-button")), t.querySelector(".atcb-initialized").append(r), r.append(i), e.buttonStyle != "default" && r.classList.add("atcb-style-" + e.buttonStyle), e.hideBranding || lt(t), t.append(l), ct(i, e.sizes), r.style.display = "none", setTimeout(function() {
...
function J(t, e = false) {
  ...
  if (a.length > 1) {
    ...
    i && (i.shadowRoot.querySelector(".atcb-initialized").style.opacity = "1", i.classList.remove("atcb-shadow-hide"), window.removeEventListener("scroll", xt), window.removeEventListener("resize", xt)), S.active = "";
  }
}
async function Wt(t, e) {
  ...
  if (c.type === "form") {
    ...
    if (s += '<form id="' + a.identifier + '-ty-form" class="pro-form' + (p ? " no-intro" : "") + '">', c.fields && c.fields.length > 0) {
      ...
      const f = ge(c.fields, a.identifier + "-ty");
  ...
  if (s += "</div></div>", await H(l, a, "checkmark", c.headline, s), c.type === "share") {
    ...
    p.addEventListener("click", async function() {
      try {
        await wt(c.url), p.innerHTML = i + m("label.share.copied", a) + "!", setTimeout(function() {
...
async function O(t, e, o, a = false) {
  ...
  if (d ? n.fields = n.fields.map((T) => T.name === "email" ? { ...T, required: true, type: "email", default: u !== "" ? u : T.default } : T) : u ? l += '<input type="hidden" name="email" id="' + e.identifier + '-rsvp-email" value="' + u + '" />' : (c += '<div class="pro-field"><label for="' + e.identifier + '-rsvp-email">' + m("form.email", e) + "<span>*</span></label>", c += '<input type="email" name="email" id="' + e.identifier + '-rsvp-email" ' + (e.disabled && "disabled") + ' aria-label="' + m("form.email", e) + '" value="" /></div>'), n.fields && n.fields.length > 0) {
    const T = ge(n.fields, e.identifier + "-rsvp", e.disabled);
  ...
  let f = null;
  if (!e.inlineRsvp)
    f = await st(t, e), V(f.querySelector(".atcb-modal-host-initialized")), await H(
      f,
      e,
      void 0,
      n.headline,
  ...
  if (Y("openRSVP", e.identifier, e.identifier), e.debug && console.log('RSVP form for "' + e.identifier + '" created'), s) {
    ...
    if (T && !e.hideButton) {
      ...
      v.hideTextLabelButton = true, v.hideIconButton = false, v.buttonsList = true, ye(t, T, v);
    }
  } else
  ...
  y && (y.addEventListener("click", async function(T) {
    ...
    let M = ve(f, [...v, ...E]);
    const dt = f.getElementById(e.identifier + "-rsvp-amount"), ot = parseInt(dt.value) || 1;
    if (n.maxpp && n.maxpp > 0 && ot > n.maxpp && (dt.classList.add("error"), M = false), M || (A.textContent = m("form.error.required", e) + "."), M) {
      ...
      let bt = n.fields ? JSON.parse(JSON.stringify(n.fields)) : [];
      const j = [];
      ...
      if (j.push({ name: "status", value: $t ? $t.value : "confirmed" }), j.push({ name: "amount", value: ot }), !d)
        ...
        const R = bt.find((ut) => ut.name === "email")?.fieldId;
        j.push({ name: "email", value: f.getElementById(R).value }), bt = bt.filter((ut) => ut.fieldId !== R);
      }
      const at = {};
      let pt = false;
      bt.forEach((R) => {
        R.type !== "label" && (R.type === "radio" ? pt || (f.querySelectorAll('[name="' + R.name + '"]').forEach(function(Nt) {
          Nt.checked && (at[R.name] = Nt.value);
        }), pt = true) : R.type === "checkbox" ? (at[R.name] = f.getElementById(R.fieldId).checked, pt = false) : (at[R.name] = f.getElementById(R.fieldId).value, pt = false));
      }), Object.keys(at).length > 0 && j.push({ name: "payload", value: at });
      const N = await xe(`https://api${e.dev ? "-dev" : ""}.add-to-calendar-pro.com/24586219-9910-41fe-9b59-df53de9db7af`, j, { rsvp: true });
      if (N === "doi" || N === true) {
...
async function jo(t, e) {
  ...
  a.classList.add("atcb-button-wrapper"), e.rtl && a.classList.add("atcb-rtl"), o.append(a), ct(a, e.sizes);
  ...
  return it(t, e, n, "rsvp", !e.hideIconButton, i, true), e.debug && console.log('Add to Calendar RSVP Button "' + e.identifier + '" created'), true;
}
async function Gt(t, e = false) {
  try {
...
function ge(t, e = "", o = false) {
  ...
  for (let c = 1; c <= t.length; c++) {
    ...
    let d = "";
    r !== "hidden" && c === i && c !== 1 && (d += "</div>"), s.type !== "hidden" && c === i && (d += '<div class="pro-field pro-field-type-' + s.type + '">'), s.type === "label" ? d += "<p>" + p + "</p>" : (s.type === "radio" && (d += "<div>"), s.type === "hidden" ? n += '<input type="hidden" name="' + s.name + '" id="' + s.fieldId + '" value="' + b + '" />' : d += Ho(s.type, s.name, p, s.fieldId, s.required, b, s.default, u, o), s.type === "radio" && (d += "</div>")), a += d, r = s.type;
  }
  return (r !== "hidden" || l) && (a += "</div>"), a += n, { html: a, fields: t };
}
function Ho(t, e, o, a, n = false, i, r = null, l = "", c = false) {
  let s = "";
...
function ve(t, e) {
  ...
  return e.forEach(function(a) {
    if (a.type !== "label" && a.type !== "radio") {
      ...
      if (a.type !== "checkbox") {
        if (n.value = tt(n.value.trim()), a.type === "number" && (n.value = n.value.replace(/\D/g, "")), a.type === "email" && n.value !== "" && !vt(n.value)) {
...
function it(t, e, o, a, n = false, i = "", r = false) {
  switch (a) {
    case "trigger":
    case "rsvp":
    default:
...
function ye(t, e, o) {
  ...
  (a ? o.options : ["default"]).forEach(function(i, r) {
    const l = document.createElement("div");
    l.classList.add("atcb-button-wrapper"), l.setAttribute("part", "atcb-button-wrapper"), o.rtl && l.classList.add("atcb-rtl"), e.append(l), ct(l, o.sizes);
    const c = document.createElement("button");
    if (c.classList.add("atcb-button"), c.setAttribute("part", "atcb-button"), o.disabled && c.setAttribute("disabled", true), o.hideTextLabelButton && c.classList.add("atcb-no-text"), o.trigger === "click" && c.classList.add("atcb-click"), o.listStyle === "overlay" && c.classList.add("atcb-dropoverlay"), c.type = "button", c.setAttribute("aria-expanded", false), l.append(c), o.buttonStyle === "date" && ke(o, c, "all", a), a) {
      c.classList.add("atcb-single");
      const s = (function() {
        return o.buttonsList && o.options.length > 1 ? m(`${o.options[`${r}`]}`, o) : o.label;
      })();
      it(t, o, c, i, !o.hideIconButton, s, true), c.id = o.identifier, o.buttonsList && (c.id = o.identifier + "-" + i);
    } else {
      it(t, o, c, "trigger", !o.hideIconButton, o.label);
...
function Po(t, e) {
  ...
  if (e.options.forEach(function(n) {
    ...
    i.classList.add("atcb-list-item"), i.setAttribute("part", "atcb-list-item"), i.role = "link", i.tabIndex = 0, a++, i.dataset.optionNumber = a, o.append(i), it(t, e, i, n, !e.hideIconList);
  }), e.listStyle === "modal") {
    const n = document.createElement("div");
    n.classList.add("atcb-list-item", "atcb-list-item-close"), n.setAttribute("part", "atcb-list-item-close"), n.role = "button", n.tabIndex = 0, a++, n.dataset.optionNumber = a, o.append(n), it(t, e, n, "close", !e.hideIconList);
  }
  return o;
}
function we(t, e = "", o = false, a = true, n = true) {
  const i = (function() {
...
function lt(t, e = true, o = false, a = false) {
  const n = document.createElement("div");
  n.id = "atcb-reference";
...
async function H(t, e, o = "", a, n = "", i = [], r = [], l = false, c = {}, s = true) {
  ...
  const b = !a || a === "" || a === void 0, p = await st(t, e, false), u = (function() {
    const h = p.getElementById("atcb-bgoverlay");
    if (!h) {
      const A = we(t, "click", true, !e.hideBackground, s);
  ...
  if (x.classList.add("atcb-modal-box"), x.setAttribute("part", "atcb-modal-box"), e.rtl && x.classList.add("atcb-rtl"), d.append(x), ct(x, e.sizes), V(u), o !== "" && !e.hideIconModal) {
  ...
  if (e.hideBranding || lt(p, false), r.length > 1) {
    const h = document.createElement("div");
    ...
    for (let y = 1; y < r.length; y++) {
      ...
      z.type = "button", z.id = e.identifier + "-" + r[0] + "-" + y, S[`${e.identifier}`][`${r[0]}`][y - 1] > 0 && z.classList.add("atcb-saved"), z.classList.add("atcb-subevent-btn"), A.append(z), ke(e, z, y, false, true), !e.dates[y - 1].overdue || e.pastDateHandling === "none" ? (y === 1 && l && z.focus(), z.addEventListener(
        "click",
        G(async () => {
    ...
    switch (h.href && h.href !== "" ? (y = document.createElement("a"), y.setAttribute("target", Bt), y.setAttribute("href", h.href), y.setAttribute("rel", "noopener")) : (y = document.createElement("button"), y.type = "button"), h.id && h.id !== "" && (y.id = h.id), y.classList.add("atcb-modal-btn"), h.primary && y.classList.add("atcb-modal-btn-primary"), h.small && y.classList.add("btn-small"), (!h.label || h.label === "") && (h.label = m("modal.button.default", e)), y.textContent = h.label, w.append(y), A === 0 && r.length < 2 && l && y.focus(), h.type) {
      ...
      case "yahoo2nd":
        y.addEventListener(
          ...
          (z.key === "Enter" || z.code == "Space" || z.key === "Alt" && z.key === "Control" && z.code === "Space") && (D(t, "close", "", "", true), await Qt(t, e, l));
        });
        break;
      case "2timeslink":
        y.addEventListener(
...
function ke(t, e, o = "all", a = false, n = false) {
  o !== "all" ? o = parseInt(o) - 1 : t.dates.length === 1 && (o = 0);
  const i = aa(t.dates, t.language, o, false, false, n), r = (function() {
...
async function Zo(t, e) {
  ...
  }), o.querySelector("button.atcb-button").removeAttribute("id"), t.host.classList.add("atcb-shadow-hide"), t.querySelector(".atcb-initialized").style.opacity = "0", Ae(t, o), window.addEventListener("scroll", xt), window.addEventListener("resize", xt), o.querySelector(".atcb-modal-host-initialized");
}
function Ko(t, e) {
...
}` : '"location":"' + t.dates[`${r}`].location + '"'), t.recurrence && t.recurrence !== "" ? l.push(...qo(t, c)) : l.push('"endDate":"' + c.end + '"'), t.dates[`${r}`].organizer && t.dates[`${r}`].organizer !== "") {
...
function Tt(t, e, o = false) {
  ...
  a && a.classList.add("atcb-saved"), ea(t, e), o && t.querySelectorAll(".atcb-modal[data-modal-nr]").length < 2 && D(t, "close");
}
function Jt(t, e, o, a = null, n = false) {
  if (B() && !Rt()) {
    ze(a, e, t, n);
    return;
  }
...
function Xo(t, e, o = "all") {
  ...
  let r = "";
  e.location && e.location !== "" && (r = e.location, r += " // ", a.push("location=" + encodeURIComponent(r))), e.descriptionHtmlFree && e.descriptionHtmlFree != "" && a.push("content=" + encodeURIComponent(r + e.descriptionHtmlFree)), U(t, "msteams", n + a.join("&"), false, o);
}
...
function Te(t, e, o, a = "all", n = false) {
  a !== "all" && (a = parseInt(a));
  const i = ta(e, a), r = (function() {
  ...
  if (r !== "" && (!B() && !e.fakeIOS || !rt() || e.bypassWebViewCheck)) {
    ee(r, i);
    return;
  }
  const l = /* @__PURE__ */ new Date(), c = ["BEGIN:VCALENDAR", "VERSION:2.0"];
  c.push("PRODID:-// https://add-to-calendar-pro.com // button v" + ue + " //EN"), c.push("CALSCALE:GREGORIAN"), a === "all" ? e.dates[0].organizer && e.dates[0].organizer !== "" ? c.push("METHOD:REQUEST") : c.push("METHOD:PUBLISH") : e.dates[`${a}`].status && e.dates[`${a}`].status.toLowerCase() === "cancelled" ? c.push("METHOD:CANCEL") : e.dates[`${a}`].organizer && e.dates[`${a}`].organizer !== "" ? c.push("METHOD:REQUEST") : c.push("METHOD:PUBLISH");
  const s = [], b = (function() {
    return a != "all" ? a : 0;
  })(), p = (function() {
  ...
  for (let d = b; d <= p; d++) {
    const f = I(e.dates[`${d}`], "clean", "ical"), k = (function() {
      ...
      if (e.dates[`${d}`].timeZone && e.dates[`${d}`].timeZone !== "") {
        const x = /GMT[+|-]\d{1,2}|Etc\/U|Etc\/Zulu|CET|CST6CDT|EET|EST|MET|MST|PST8PDT|WET|PST|PDT|MDT|CST|CDT|EDT|EEST|CEST|HST|HDT|AKST|AKDT|AST|ADT|AEST|AEDT|NZST|NZDT|IST|IDT|WEST|ACST|ACDT|BST/i.test(e.dates[`${d}`].timeZone) ? "GMT" : e.dates[`${d}`].timeZone, w = Ue(x);
...
function ea(t, e) {
  Y("success", e.identifier, e.identifier), e.ty && typeof Wt == "function" && setTimeout(() => {
    Wt(t, e);
  }, 1e3);
}
function ee(t, e) {
...
function oe(t, e, o, a) {
  o === "currentBrowser" && (o = Intl.DateTimeFormat().resolvedOptions().timeZone);
  const n = /* @__PURE__ */ new Date(`${t}T${e}:00Z`), i = C(o, t, e), r = new Date(n.getTime() - oa(i));
...
function aa(t, e = "en", o = "all", a = false, n = false, i = false, r = false) {
  a && (t = me({ dates: t }).dates);
...
function Ee(t, e = true) {
  ...
  if (o.BYWEEKDAY || o.BYDAY) {
    ...
    if (e) {
      const { plainWeekdays: n, ordinals: i } = ra(a);
...
function ca(t, e) {
  ...
  try {
    const o = la(e).formatToParts(t), a = (u) => o.find((d) => d.type === u)?.value || "", n = a("weekday");
    let i = null;
    switch (n) {
      case "Sun":
        i = 0;
...
function ba(t) {
  ...
  return {
    ...t,
    month0: e,
    dayOfYear: Le(t.year, e, t.day),
    weekNumber: da(t.year, e, t.day)
  };
}
function F(t, e) {
  const o = e ? ca(t, e) : null;
  return ba(o || sa(t));
}
function pa(t, e, o, a, n = null) {
  const i = n || F(t, o), r = Number.isFinite(i.month0) ? i.month0 : Number.isFinite(i.month) ? i.month - 1 : 0, l = Date.UTC(i.year, r, i.day) + e * 864e5, c = new Date(l), s = `${c.getUTCFullYear()}-${yt(c.getUTCMonth() + 1)}-${yt(c.getUTCDate())}`, b = o || "UTC";
  try {
    const p = C(b, s, a);
    return /* @__PURE__ */ new Date(`${s}T${a}:00${ia(p)}`);
  } catch {
    return new Date(t.getTime() + e * 864e5);
  }
}
function ua(t, e, o, a, n, i) {
...
function ma(t, e, o, a, n, i) {
  return !(!fa(t, e, a, n) || !ha(t, e, o, a, n, i));
}
function fa(t, e, o, a) {
  const n = a || F(t, o);
  ...
  if (e.BYDAY_ORDINALS && Array.isArray(e.BYDAY_ORDINALS) && e.BYDAY_ORDINALS.length > 0) {
    const c = n.weekday, s = n.year, b = n.month0, p = n.dayOfYear, u = new Date(Date.UTC(s, b + 1, 0)).getUTCDate(), d = Le(s, 11, 31), f = (w, h) => {
      if (w === 0) return false;
      if (w > 0) {
...
function ga(t, e, o, a, n = "UTC") {
  const i = Ee(t), r = F(e, n), l = `${yt(r.hour)}:${yt(r.minute)}`;
  ...
  for (; !(i.UNTIL && b > i.UNTIL); ) {
    const x = F(b, n);
    if (ua(b, i, e, n, x, r) && ma(b, i, e, n, x, r) && (p.push(b), u++, i.COUNT && u >= i.COUNT || !i.COUNT && !i.UNTIL && (a ? b >= s : b > s)) || --d <= 0)
      break;
    b = pa(b, 1, n, l, x);
  }
  let f = null, k = 0;
...
function Y(t, e, o) {
  ...
  a && a.setAttribute("atcb-last-event", t + ":" + e), $() && xa(t, e);
}
function xa(t, e) {
  let o = "";
  switch (t) {
...
var wa = Object.keys(_t);
function m(t, e) {
  return e.customLabels && e.customLabels[`${t}`] && e.customLabels[`${t}`] !== "" ? X(e.customLabels[`${t}`]) : Ye(t, e.language);
}
function Ye(t, e) {
  return e || (e = "en"), _t[`${e}`][`${t}`] ? _t[`${e}`][`${t}`] : e !== "en" ? Ye(t, "en") : t;
}
var Ct = false;
var ht = 0;
...
if ($()) {
  class t extends HTMLElement {
    ...
    async initializeComponent() {
      ...
      try {
        this.hasAttribute("proKey") && this.getAttribute("proKey") !== "" || this.hasAttribute("prokey") && this.getAttribute("prokey") !== "" ? (this.hasAttribute("proKey") && this.getAttribute("proKey") !== "" ? this.data = await nt(this.getAttribute("proKey"), this) : this.data = await nt(this.getAttribute("prokey"), this), this.data.proKey && (this.proKey = this.data.proKey)) : (this.data.proKey = "", this.data = await le(this, this.debug));
      } catch (a) {
    ...
    disconnectedCallback() {
      ce(this.shadowRoot, this.identifier), this.debug && console.log('Add to Calendar Button "' + this.identifier + '" destroyed'), document.querySelectorAll("add-to-calendar-button").length === 0 && (ht = 0);
    }
    static get observedAttributes() {
      const o = ["instance", "prokey", "proKey", "prooverride", "proOverride"];
      return this.proKey && this.proKey !== "" ? Lt.map((a) => a.toLowerCase()).concat(o) : gt.map((a) => a.toLowerCase()).concat(o);
    }
    ...
    async updateComponent() {
      ...
      try {
        this.hasAttribute("proKey") && this.getAttribute("proKey") !== "" ? (this.data = await nt(this.getAttribute("proKey"), this), this.data.proKey && (this.proKey = this.data.proKey)) : this.hasAttribute("prokey") && this.getAttribute("prokey") !== "" ? (this.data = await nt(this.getAttribute("prokey"), this), this.data.proKey && (this.proKey = this.data.proKey)) : this.data = await le(this, this.debug);
      } catch (a) {
        this.debug && (console.error(a), Et(this.shadowRoot, a)), this.updatePending = false;
        return;
      }
      ce(this.shadowRoot, this.identifier), await this.initButton(), this.updatePending = false;
    }
    async initButton() {
      if (this.state.initialized || (ht = ht + 1), this.identifier && this.identifier !== "")
        ...
        (this.data.identifier == null || this.data.identifier == "") && (this.data.identifier = "atcb-btn-" + ht), this.identifier = this.data.identifier;
      }
      this.setAttribute("atcb-button-id", this.data.identifier);
      try {
        return this.style.visibility = "visible", this.style.opacity = "1", this.style.position = "relative", this.style.outline = "none", await ka(this.shadowRoot, this.data), true;
      } catch (o) {
...
function De(t, e = gt) {
  ...
  for (let a = 0; a < e.length; a++) {
    ...
    if (t.hasAttribute(`${n}`)) {
      ...
      else if (Ze.includes(n)) {
        const l = (function() {
          return !i || i === "" ? "{}" : i.substring(0, 1) != "{" ? "{" + i + "}" : i;
        })();
        r = JSON.parse(l);
      } else if (Ke.includes(n)) {
        const l = (function() {
          return !i || i === "" ? "[]" : i.substring(0, 1) != "[" ? "[" + i + "]" : i;
        })();
        r = JSON.parse(l);
      } else qe.includes(n) ? (r = i, i.includes("[") && (r = r.substring(1, r.length - 1)), (i.includes('"') || i.includes("'")) && (r = r.substring(1, r.length - 1)), i.includes("|") || (r = r.replace(/\s/g, "")), r.includes("','") ? r = r.split("','") : r = r.split('","')) : Ve.includes(n) ? r = parseInt(i) : r = i;
...
async function ka(t, e) {
  try {
    t.host.classList.add("add-to-calendar"), e = await It(e), await fe(e);
    const o = t.querySelector(".atcb-initialized");
    return zt(t, e), o.setAttribute("lang", e.language), Ut(t, o, e), Ce(e), Re(t, e), Me(e.proKey, e.hideBranding, e.debug), e.hidden || (typeof O == "function" && e.rsvp && Object.keys(e.rsvp).length > 0 ? e.inlineRsvp ? await O(t, e, o) : await jo(t, e) : ye(t, o, e), !e.hideRichData && !e.subscribe && e.name && e.dates[0].location && e.dates[0].startDate && Ko(e, t.host)), Y("initialization", e.identifier, e.identifier), !e.proKey && e.hideBranding && !document.getElementById("atcb-reference") && lt(document.body, false, false, true), true;
  } catch (o) {
    throw new Error(o.message);
  }
}
...
async function Ut(t, e = null, o) {
  ...
  if (o.customCss && o.customCss !== "") {
    ...
    if (c.setAttribute("rel", "stylesheet"), c.setAttribute("type", "text/css"), c.setAttribute("href", o.customCss), a && c.setAttribute("nonce", a), !e)
      await se(c, t, null, a, null, false, false, r + l);
    else {
      const s = document.createElement("div");
      s.classList.add("atcb-placeholder"), t.prepend(s);
      const b = document.createElement("style");
      b.innerText = ".atcb-placeholder { background-color: #777; border-radius: 200px; height: 40px; opacity: .3; width: 150px; }", a && b.setAttribute("nonce", a), t.prepend(b), se(c, t, e, a, s, o.inline, o.buttonsList, r + l);
    }
    return;
  }
...
async function se(t, e, o = null, a = null, n = null, i = false, r = false, l = "") {
  if (l !== "") {
    const c = document.createElement("style");
...
function Et(t, e) {
  ...
  const o = _e(t), a = document.createElement("div");
...
async function La(t, e, o = false) {
  ...
  if (r && (J(r.shadowRoot, false), S[`${S.active}`] && delete S[`${S.active}`], r.remove()), Y("initialization", a.identifier, a.identifier), !a.blockInteraction && !a.hidden) {
    ...
    Ce(a), zt(l.shadowRoot, a), l.shadowRoot.querySelector(".atcb-initialized").setAttribute("lang", a.language), Ut(l.shadowRoot, s, a), Re(l.shadowRoot, a), typeof O == "function" && a.rsvp && Object.keys(a.rsvp).length > 0 ? O(l.shadowRoot, a, e, o) : i ? (await K(l.shadowRoot, a.options[0], a, "all", o), Y("openSingletonLink", a.identifier, a.identifier)) : D(l.shadowRoot, "open", a, e, o);
  }
  return Me(a.proKey, a.hideBranding, a.debug), a.debug && console.log('Add to Calendar Button "' + a.identifier + '" triggered'), a.identifier;
}
function Ce(t) {
  const e = [];
...
async function nt(t, e = null, o = {}) {
  if (t && t !== "")
    try {
      const a = e ? e.proOverride : o.proOverride, n = e ? De(e, a ? gt : Lt) : o, i = await fetch(`https://${n.dev ? "event-dev.caldn.net" : "event.caldn.net"}/${t}/config.json`);
      if (i.ok) {
...
function Re(t, e) {
  if ($()) {
    if (e.lightMode == "bodyScheme") {
      const o = kt.get(e.identifier);
      o && o.disconnect();
      const a = new MutationObserver(function(n) {
        n.forEach((i) => {
          i.attributeName === "class" && zt(t, e);
        });
      });
      a.observe(document.documentElement, { attributes: true }), a.observe(document.body, { attributes: true }), kt.set(e.identifier, a);
    }
    Ct || (document.addEventListener("keyup", Ta), document.addEventListener("keydown", za), window.addEventListener("resize", Aa));
  }
}
function Ta(t) {
  const e = (function() {
