...
const ue = "2.14.0", Ft = {
  ...
  "forceOverlay",
  "dev"
], Ze = ["customLabels", "ty", "rsvp", "customVar"], Ke = ["dates"], qe = ["recurrence_byDay", "recurrence_byMonth", "recurrence_byMonthDay", "images", "options", "optionsMobile", "optionsIOS"], Ve = ["sequence", "recurrence_interval", "recurrence_count"], Q = {
...
function Qe(t) {
  if (t.recurrence = t.recurrence.replace(/\s+/g, "").toUpperCase(), /^RRULE:/i.test(t.recurrence)) {
    t.recurrence_simplified = !1;
    const e = Ee(t.recurrence, !1);
...
function eo(t, e) {
  ...
  for (let i = 0; i < t.length; i++) {
    const r = oo(t[`${i}`]);
    r === "apple" && (n = !0), r === "ical" && (a = !0), !ao(r, e) && o.push(r);
  }
...
function fo(t) {
  return t.language.length > 2 && (t.language = t.language.substring(0, 2)), ya.includes(t.language) ? t.rtl = !0 : t.rtl = !1, t;
}
function me(t) {
...
async function fe(t) {
  ...
  try {
    return await he(t, e), await Ao(t, e), await So(t, e), await Eo(t, e), await Lo(t, e), await Yo(t, e), await Do(t, e), await $o(t, e), t.recurrence_simplified && await No(t, e), !0;
  } catch (o) {
...
async function Vt(t, e, o = null, a = !1, n = !1) {
  ...
  if (e.listStyle === "modal") {
    ...
    s.querySelector(".atcb-modal-host-initialized").append(l), l.append(i), e.hideBranding || lt(s, !1), ct(i, e.sizes), Ot(s), V(l);
  } else
...
async function O(t, e, o, a = !1) {
  ...
  if (Y("openRSVP", e.identifier, e.identifier), e.debug && console.log('RSVP form for "' + e.identifier + '" created'), s) {
    ...
    if (T && !e.hideButton) {
      ...
      v.hideTextLabelButton = !0, v.hideIconButton = !1, v.buttonsList = !0, ye(t, T, v);
    }
  } else
  ...
  y && (y.addEventListener("click", async function(T) {
    ...
    if (n.maxpp && n.maxpp > 0 && ot > n.maxpp && (dt.classList.add("error"), M = !1), M || (A.textContent = m("form.error.required", e) + "."), M) {
      ...
      bt.forEach((R) => {
        ...
        }), pt = !0) : R.type === "checkbox" ? (at[R.name] = f.getElementById(R.fieldId).checked, pt = !1) : (at[R.name] = f.getElementById(R.fieldId).value, pt = !1));
      }), Object.keys(at).length > 0 && j.push({ name: "payload", value: at });
      const N = await xe(`https://api${e.dev ? "-dev" : ""}.add-to-calendar-pro.com/24586219-9910-41fe-9b59-df53de9db7af`, j, { rsvp: !0 });
      if (N === "doi" || N === !0) {
...
async function jo(t, e) {
  ...
  return it(t, e, n, "rsvp", !e.hideIconButton, i, !0), e.debug && console.log('Add to Calendar RSVP Button "' + e.identifier + '" created'), !0;
}
...
function Ho(t, e, o, a, n = !1, i, r = null, l = "", c = !1) {
  let s = "";
...
function ye(t, e, o) {
  ...
  (a ? o.options : ["default"]).forEach(function(i, r) {
    ...
    if (c.classList.add("atcb-button"), c.setAttribute("part", "atcb-button"), o.disabled && c.setAttribute("disabled", !0), o.hideTextLabelButton && c.classList.add("atcb-no-text"), o.trigger === "click" && c.classList.add("atcb-click"), o.listStyle === "overlay" && c.classList.add("atcb-dropoverlay"), c.type = "button", c.setAttribute("aria-expanded", !1), l.append(c), o.buttonStyle === "date" && ke(o, c, "all", a), a) {
      c.classList.add("atcb-single");
      const s = (function() {
        return o.buttonsList && o.options.length > 1 ? m(`${o.options[`${r}`]}`, o) : o.label;
      })();
      it(t, o, c, i, !o.hideIconButton, s, !0), c.id = o.identifier, o.buttonsList && (c.id = o.identifier + "-" + i);
    } else {
...
async function H(t, e, o = "", a, n = "", i = [], r = [], l = !1, c = {}, s = !0) {
  ...
  const b = !a || a === "" || a === void 0, p = await st(t, e, !1), u = (function() {
    const h = p.getElementById("atcb-bgoverlay");
    if (!h) {
      const A = we(t, "click", !0, !e.hideBackground, s);
  ...
  if (e.hideBranding || lt(p, !1), r.length > 1) {
    const h = document.createElement("div");
    ...
    for (let y = 1; y < r.length; y++) {
      ...
      z.type = "button", z.id = e.identifier + "-" + r[0] + "-" + y, S[`${e.identifier}`][`${r[0]}`][y - 1] > 0 && z.classList.add("atcb-saved"), z.classList.add("atcb-subevent-btn"), A.append(z), ke(e, z, y, !1, !0), !e.dates[y - 1].overdue || e.pastDateHandling === "none" ? (y === 1 && l && z.focus(), z.addEventListener(
        "click",
        G(async () => {
    ...
    switch (h.href && h.href !== "" ? (y = document.createElement("a"), y.setAttribute("target", Bt), y.setAttribute("href", h.href), y.setAttribute("rel", "noopener")) : (y = document.createElement("button"), y.type = "button"), h.id && h.id !== "" && (y.id = h.id), y.classList.add("atcb-modal-btn"), h.primary && y.classList.add("atcb-modal-btn-primary"), h.small && y.classList.add("btn-small"), (!h.label || h.label === "") && (h.label = m("modal.button.default", e)), y.textContent = h.label, w.append(y), A === 0 && r.length < 2 && l && y.focus(), h.type) {
      ...
      case "yahoo2nd":
        y.addEventListener(
          ...
          (z.key === "Enter" || z.code == "Space" || z.key === "Alt" && z.key === "Control" && z.code === "Space") && (D(t, "close", "", "", !0), await Qt(t, e, l));
        });
        break;
      case "2timeslink":
        y.addEventListener(
...
function ke(t, e, o = "all", a = !1, n = !1) {
  o !== "all" ? o = parseInt(o) - 1 : t.dates.length === 1 && (o = 0);
  const i = aa(t.dates, t.language, o, !1, !1, n), r = (function() {
...
function Xo(t, e, o = "all") {
  ...
  let r = "";
  e.location && e.location !== "" && (r = e.location, r += " // ", a.push("location=" + encodeURIComponent(r))), e.descriptionHtmlFree && e.descriptionHtmlFree != "" && a.push("content=" + encodeURIComponent(r + e.descriptionHtmlFree)), U(t, "msteams", n + a.join("&"), !1, o);
}
...
function aa(t, e = "en", o = "all", a = !1, n = !1, i = !1, r = !1) {
...
let Ct = !1, ht = 0;
const kt = /* @__PURE__ */ new Map(), Mt = '<div class="atcb-initialized atcb-hidden"></div>';
if ($()) {
  class t extends HTMLElement {
    ...
    async updateComponent() {
      ...
      ce(this.shadowRoot, this.identifier), await this.initButton(), this.updatePending = !1;
    }
    async initButton() {
      ...
      try {
        return this.style.visibility = "visible", this.style.opacity = "1", this.style.position = "relative", this.style.outline = "none", await ka(this.shadowRoot, this.data), !0;
      } catch (o) {
...
async function Ut(t, e = null, o) {
  ...
  if (o.customCss && o.customCss !== "") {
    ...
    if (c.setAttribute("rel", "stylesheet"), c.setAttribute("type", "text/css"), c.setAttribute("href", o.customCss), a && c.setAttribute("nonce", a), !e)
      await se(c, t, null, a, null, !1, !1, r + l);
    else {
      const s = document.createElement("div");
...
async function se(t, e, o = null, a = null, n = null, i = !1, r = !1, l = "") {
  if (l !== "") {
    const c = document.createElement("style");
...
function Re(t, e) {
  if ($()) {
    if (e.lightMode == "bodyScheme") {
      ...
      a.observe(document.documentElement, { attributes: !0 }), a.observe(document.body, { attributes: !0 }), kt.set(e.identifier, a);
    }
